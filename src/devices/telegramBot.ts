...
export abstract class TelegramBotX<
  Msg,
  P,
  D extends TelegramNode<P>,
> extends Device<D, Msg> {
  abstract publish(ctx: RuntimeContext<Msg>, device: D): Promise<void>
...
export type TelegramMessageNode = TelegramNode<string> & {
  type: 'telegramMessage'
}
export class TelegramMessage<Msg> extends TelegramBotX<
  Msg,
  string,
  TelegramMessageNode
> {
